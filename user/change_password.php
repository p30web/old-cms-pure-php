...
<head>
    <title>ایران دوج | تغییر رمز عبور</title>
              ...
              id="Mask-Copy" fill="#000000" fill-rule="nonzero"/>
                            ...
                            <span class="kt-widget__desc">
                                اطلاعات شخصی
                                                    ...
                                                    <a href="change_password.php" class="kt-widget__item kt-widget__item--active">
                        <span class="kt-widget__section">
                            <span class="kt-widget__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                    ...
                                    <div class="col-xl-12 col-lg-12 order-lg-12 order-xl-12">
                                        <div class=" alert alert-light alert-elevate fade show " role="alert">
                                            ...
                                            <div class="alert-text">
                                                رمز عبور خود را بر اساس رعایت نکات امنیتی تعیین کنید و در نگه داری آن دقت کنید زیرا ایران دوج مسئولیتی را در قبال از دست دادن رمز عبور شما قبول نمیکند. برای تعیین رمز عبور این مطلب را  <a class="kt-link kt-font-bold" href="#">مطالعه کنید</a>.
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-9 form-group">
                                                            ...
                                                            <input type="password" name="currentpass" class="form-control"
                                                                   placeholder="رمز عبور فعلی"  autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <div class="col-md-9 form-group">
                                                        ...
                                                        <div class="col-md-9 form-group">
                                                            ...
                                                            <input type="password" name="confrimnewpass" class="form-control"
                                                                   placeholder="تکرار رمز عبور جدید"  autocomplete="off">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="kt-portlet__foot">
                                                    <div class="kt-form__actions">
                                                        <button type="submit" id="change_pass_submit" class="btn btn-primary">ویرایش رمز عبور</button>
                                                    </div>
                                                </div>
                                            </form>
                                            <!--end::Form-->
...
<script>
    ...
    KTUtil.ready(function () {
        ...
        $("#change_pass_submit").click(function (t) {
            t.preventDefault();
            var e = $(this), n = $(this).closest("form");
            // console.log(1);
            n.validate({
                rules: {
                    currentpass: {required: !0},
                    newpass: {required: !0},
