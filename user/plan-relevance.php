...
$cols = array("*");
$fetch_investment_plan = $db->get("settings_param");
...
if($PlanType == "dollar"){
    $query_investment_plan = sprintf("SELECT * FROM `dollar_investment_plan` WHERE status = '1' AND `end_date` IS NOT NULL ORDER BY sort ASC");
}elseif ($PlanType == "dog"){
    $query_investment_plan = sprintf("SELECT * FROM `investment_plan` WHERE status = '1' AND `end_date` IS NOT NULL ORDER BY sort ASC");
}
...
<head>
    ...
    <title><?php echo $fetch_investment_plan[13]['value']; ?></title>
...
">نوع پلنی که میخواهید سرمایه گذاری کنید را انتخاب کنید : </div><div class="box" style="
    ...
    margin-top: 17px;
">
                                        <a href="https://www.irandogebank.com/user/plan-relevance.php?plan-type=dog" class="plan-t2 <?php echo ($PlanType == "dog") ? 'active-type' : ''; ?>">دوج کوین</a>
                                        <a href="https://www.irandogebank.com/user/plan-relevance.php?plan-type=dollar" class="plan-t2 <?php echo ($PlanType == "dollar") ? 'active-type' : ''; ?>">دلار</a>
                                    </div>
                                    ...
                                    <div class="kt-pricing-1__items row">
                                        ...
                                        do {
                                            ...
                                            <div class="kt-pricing-1__item col-lg-3">
                                                <?php// print_r($row_investment_plan) ?>
                                                ...
                                                <h3 class="kt-pricing-1__subtitle" style="margin-top: -7px;background: #3d94fb;"><p  style="margin-bottom: 0;" id="demo<?php  echo $row_investment_plan['id']; ?>"></p></h3>
                                                <script>
                                                    // Set the date we're counting down to
                                                    var countDownDate = new Date("<?php echo $row_investment_plan['end_date']; ?>").getTime();
                                                    ...
                                                    var x = setInterval(function() {
                                                        ...
                                                        document.getElementById("demo<?php  echo $row_investment_plan['id']; ?>").innerHTML = days + "روز " + hours + "ساعت "
                                                            + minutes + "دقیقه " + seconds + "ثانیه ";

                                                        // If the count down is over, write some text
                                                        if (distance < 0) {
                                                            clearInterval(x);
                                                            document.getElementById("demo<?php  echo $row_investment_plan['id']; ?>").innerHTML = "EXPIRED";
                                                        }
                                                    }, 1000);
                                                </script>
                                ...
                                <li><span>سود در هر روز:</span><strong>
                                         ...
                                         else if ($row_investment_plan['period_type'] === "3month") {
                                             echo number_format((float)$d / 30, 2, '.', '');
                                         }

                                         else if ($row_investment_plan['period_type'] === "6month") {
                                             echo number_format((float)$d / 30, 2, '.', '');
                                         }

                                         else if ($row_investment_plan['period_type'] === "yearly") {
                                             echo number_format((float)$d / 30, 2, '.', '');
                                         }
