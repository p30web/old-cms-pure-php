                                        ...
                                        <div class="kt-wizard-v1__content wizard_content3" data-ktwizard-type="step-content">
                                            ...
                                            <div class="kt-form__section kt-form__section--first">
                                                <div class="kt-wizard-v1__review">
                                                    <div class="kt-portlet__body">
                                                        <div class="p30web-box-final">
                                                            <form class="final_submit" method="post">
                                                                <div class="col-md-12 form-group">
                                                                    <label>تعداد دوج کوینی واریزی : </label>
                                                                    <input type="text" name="amount" class="form-control" placeholder="تعداد دوج کوینی که واریز کرده اید را به همراه اعشار وارد نمایید" autocomplete="off">
                                                                    <span class="form-text text-muted">مبلغی که واریز کرده اید (باید حتما اعشاری باشد) را در اینجا وارد نمایید</span>
                                                                </div>
                                                                <div class="form-group">
                                                    ...
                                                    <div class="kt-portlet__foot">
                                                        <div class="p30web-ok">
                                                            <button type="submit" id="finalv_submit" class="btn btn-primary">ثبت و ارسال</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
