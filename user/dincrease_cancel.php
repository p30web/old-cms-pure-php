                                ...
                                <div class="kt-grid kt-wizard-v1 kt-wizard-v1--white" id="kt_wizard_v1" data-ktwizard-state="step-first">
                                    ...
                                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v1__wrapper">
                                        ...
                                        <div class="base-content">
                                            ...
                                            $pay_Code = rand(1,9) . rand(1,9) . rand(1,9) . rand(1,9);

                                            $trans_id = "PW" . $pay_Code . "OR" . rand(1,9);
                                            ...
                                            if ($db->count > 0) {
                                                $payment_log = array(
                                                    ...
                                                    "description"=> "لغو پرداخت توسط کاربر",
                                                );

                                                if($db->insert("payment_log" , $payment_log)){

                                                    echo '<div class="kt-heading kt-heading--md">
                                                <div class="alert alert-danger" role="alert">
                                                    <div class="alert-text">پرداخت ناموفق بود</div>
                                                </div>
                                            </div>';
