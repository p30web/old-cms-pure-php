                                        ...
                                        <div class="base-content">
                                            ...
                                            <div class="kt-heading kt-heading--md">
                                                <div class="alert alert-dark" role="alert">
                                                    <div class="alert-text">برای افزایش موجودی ابتدا انتخاب نمایید، که مایل هستید کدام کیف پول خود را شارژ نمایید.</div>
                                                </div>
                                            </div>

                                            <div class="select-type">
                                                <a href="increase_credit.php" class="btn btn-success btn-brand">افزایش موجودی کیف پول دوج کوین</a>
                                                <a href="dincrease_credit.php" class="btn btn-brand">افزایش موجودی کیف پول دلاری</a>
                                            </div>
