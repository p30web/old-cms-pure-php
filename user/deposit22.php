										...
										<div class="kt-portlet kt-portlet--height-fluid">
											...
											<div class="kt-portlet__body">
												<div class="wallet_address">
													<img src="https://dogechain.info/api/v1/address/qrcode/<?php echo $fetch_wallets['ac_wallet']; ?>">
													<p>
														<?php echo $fetch_wallets['description']; ?>
													</p>
													<h3><a id="wallet_add"><?php echo $fetch_wallets['ac_wallet']; ?></a><button type="button" data-clipboard="true" data-clipboard-target="#wallet_add" class="btn btn-info btn-icon btn-circle"><i class="flaticon2-copy"></i></button></h3>
												</div>
											</div>
										</div>
