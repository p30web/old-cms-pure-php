                        ...
                        <span class="kt-widget__section">
                            ...
                            <span class="kt-widget__desc">
                                کیف پول من
                                                    ...
                                                    <a href="user_settings.php" class="kt-widget__item  kt-widget__item--active">
                        <span class="kt-widget__section">
                            <span class="kt-widget__icon">
                                            ...
                                            <form class="kt-form" id="form_deposit" method="post">
                                                <div class="kt-portlet__body">
                                                    <div class="form-group row">
                                                        <label class="col-3 col-form-label">تایید دو مرحله ای </label>
                                                        <div class="col-3">
                                                            <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                                                <label>
                                                                    <input type="checkbox" <?php if($fetch_member['two_step'] === "on") echo 'checked'; ?> name="twostepver">
                                                                    <span></span>

                                                                </label>
                                                            </span>
                                                            <span class="form-text text-muted">با فعال کردن تایید دو مرحله ای برای عملیات کاربر همانند ورود و... نیاز به تایید کاربر از طریق ایمل میباشد</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="kt-portlet__foot">
                                                    <div class="kt-form__actions">
                                                        <button type="submit" id="user_settings_submit" class="btn btn-primary">بروز رسانی تنظیمات</button>
                                                    </div>
                                                </div>
                                            </form>
                                            <!--end::Form-->
...
<script>
    ...
    KTUtil.ready(function () {
        ...
        $("#user_settings_submit").click(function (t) {
            t.preventDefault();
            var e = $(this), n = $(this).closest("form");
            // console.log(1);
            n.validate({
                rules: {
                    twostepver:{ required: false}
