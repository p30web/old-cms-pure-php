        ...
        init: function () {
            n(), $("#kt_login_signin_submit").click(function (t) {
                ...
                $("#kt_login_resetpass_submit").click(function (n) {
                    ...
                    if(verfycode == null){
                        $(".kt-form").html("<div class=\"kt-alert kt-alert--outline alert alert-danger alert-dismissible\" role=\"alert\">\t\t\t<button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"></button>\t\t\t<span>لینک بازیابی رمز عبور صحیح نمی باشد.</span>\t\t</div>")
                    }
                            ...
                            if(l.status === 200){
                                ...
                                if(l.responseJSON.status === 404){
                                    ...
                                    setTimeout(function () {
                                        ...
                                        n.clearForm(), n.validate().resetForm(), i(n, "success", "اطلاعات شما با موفقیت بروز رسانی شد، هم اکنون میتوانید وارد شوید")
                        ...
                        if(l.status === 200){
                            ...
                            if(l.responseJSON.status === 404){
                                ...
                                setTimeout(function () {
                                    ...
                                    s.removeClass("kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light").attr("disabled", !1), r.clearForm(), r.validate().resetForm(), e();
                                    var n = t.find(".kt-login__signin form");
                                    n.clearForm(), n.validate().resetForm(), i(n, "success", "ایمیل بازریابی رمز عبور برای شما ارسال شد، ایمیل خود را چک نمایید")
