...
var KTUtil = function () {
    ...
    return {
        init: function (t) {
            ...
            if (t && void 0 !== e) {
                var a = e.split(" ");
                if (t.classList) for (var n = 0; n < a.length; n++) a[n] && a[n].length > 0 && t.classList.add(KTUtil.trim(a[n])); else if (!KTUtil.hasClass(t, e)) for (n = 0; n < a.length; n++) t.className += " " + KTUtil.trim(a[n])
            }
        }, removeClass: function (t, e) {
            if (t && void 0 !== e) {
                var a = e.split(" ");
                if (t.classList) for (var n = 0; n < a.length; n++) t.classList.remove(KTUtil.trim(a[n])); else if (KTUtil.hasClass(t, e)) for (n = 0; n < a.length; n++) t.className = t.className.replace(new RegExp("\\b" + KTUtil.trim(a[n]) + "\\b", "g"), "")
            }
...
KTUtil.ready(function () {
    ...
    t.fn.KTDatatable = function (i) {
        ...
        translate: {
            records: {processing: "لطفا صبر کنید...", noRecords: "موردی برای نمایش یافت نشد."},
            toolbar: {
                pagination: {
                    items: {
                        default: {
...
var KTOffcanvas = function (t, e) {
    ...
    KTUtil.get("body");
    if (n) {
        var i = {startStep: 1, manualStepForward: !1}, o = {
            construct: function (t) {
        ...
        if (e) {
            ...
            var a = function () {
                ...
                if (0 !== n.value.length) {
                    ...
                    var o,
                        l = '<div class="kt-chat__user"><span class="kt-chat__datetime">Just now</span><a href="#" class="kt-chat__username">Jason Muller</span></a><span class="kt-userpic kt-userpic--circle kt-userpic--sm"><img src="./assets/media/users/100_12.jpg" alt="image"></span></div><div class="kt-chat__text kt-bg-light-brand">' + n.value;
    ...
    return {
        init: function () {
            t(KTUtil.getByID("kt_chat_modal")), setTimeout(function () {
            }, 1e3)
        }, setup: function (e) {
            t(e)
        }
    ...
    return {
        init: function () {
            !function () {
                ...
                var a = KTUtil.find(e, ".kt-demo-panel__head"), n = KTUtil.find(e, ".kt-demo-panel__body");
                KTUtil.scrollInit(n, {
                    disableForMobile: !0,
                    resetHeightOnDestroy: !0,
                    handleWindowResize: !0,
...
var KTOffcanvasPanel = function () {
    var t = KTUtil.get("kt_offcanvas_toolbar_notifications"), e = KTUtil.get("kt_offcanvas_toolbar_quick_actions"),
        a = KTUtil.get("kt_offcanvas_toolbar_profile"), n = KTUtil.get("kt_offcanvas_toolbar_search");
    return {
        init: function () {
            !function () {
                ...
                var t = KTUtil.find(n, ".kt-offcanvas-panel__head"), e = KTUtil.find(n, ".kt-offcanvas-panel__body");
                new KTOffcanvas(n, {
                    overlay: !0,
                    baseClass: "kt-offcanvas-panel",
...
var KTQuickPanel = function () {
    var t = KTUtil.get("kt_quick_panel"), e = KTUtil.get("kt_quick_panel_tab_notifications"),
        a = KTUtil.get("kt_quick_panel_tab_logs"), n = KTUtil.get("kt_quick_panel_tab_settings"), i = function () {
...
var KTLayout = function () {
    ...
    return {
        init: function () {
            ...
            var e, a, o, l, r, s, d;
            o = KTUtil.get("kt_aside"), KTUtil.get("kt_aside_brand"), l = KTUtil.hasClass(o, "kt-aside--offcanvas-default") ? "kt-aside--offcanvas-default" : "kt-aside", i = new KTOffcanvas("kt_aside", {
                baseClass: l,
                overlay: !0,
                closeBy: "kt_aside_close_btn",
                toggleBy: {target: "kt_aside_mobile_toggler", state: "kt-header-mobile__toolbar-toggler--active"}
            }), KTUtil.hasClass(t, "kt-aside--fixed") && (KTUtil.addEvent(o, "mouseenter", function (i) {
                i.preventDefault(), !1 !== KTUtil.isInResponsiveRange("desktop") && (a && (clearTimeout(a), a = null), e = setTimeout(function () {
                ...
                i.preventDefault(), !1 !== KTUtil.isInResponsiveRange("desktop") && (e && (clearTimeout(e), e = null), a = setTimeout(function () {
                ...
                rememberPosition: !0,
                height: function () {
                    return KTUtil.isInResponsiveRange("desktop") ? parseInt(KTUtil.getViewPort().height) - parseInt(KTUtil.actualHeight("kt_header", !1)) - parseInt(KTUtil.css(s, "marginTop")) - parseInt(KTUtil.css(s, "marginBottom")) : parseInt(KTUtil.getViewPort().height)
                }
            ...
            KTUtil.get("kt_page_portlet") && ((o = l()).initSticky(), KTUtil.addResizeHandler(function () {
                o.updateSticky()
            }), l())
