...
class KT_image {
	...
	/**
	 * errors message to be displayed as User Error
	 * @var array 
	 * @access private
	 */
	var $errorType = array();
	...
	/**
	 * errors message to be displayed as Developer Error
	 * @var array
	 * @access private
	 */
	 ...
	 * @return array (x, y) on succes, [array] (-1, -1) on errors;
	 * @access public
	 */
	...
	/**
	 * return an image handle or set an errors if not succeded;
	 * @param string $sourceFileName path to the source file;
	 * @return integer image handle to the image if succeded or set errors;
	 * @access private
	 */
	...
	/**
	 * return the errors string if the selected library not working;
	 * @return string ;
	 * @access private;
	 */
	 ...
	 * If the folder does not have write permissions or if could not create it, set errors.
	...
	/**
	 * Setter. set errors for developper and user.
	 * @var string $errorCode errors message code;
	...
	/**
	 * check if an errors was setted.
	 * @return boolean true if errors is set or false if not;
	 * @access public
	 */
	function hasError()
	{	
	 ...
	 * @return array  array - 0=>errors for user, 1=>errors for developer;
	 * @access public
	 */
	function getError()
	{
