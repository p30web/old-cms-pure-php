...
class Net_SMTP
{
     ...
     * SMTP server - an errors will be thrown if the command string
     ...
     *                  a PEAR_Error object is an errors condition is reached.
     *
     * @access  private
     * @since   1.1.0
     *
     ...
     *                              be used?
     *
     * @return mixed Returns a PEAR_Error with an errors message on any
    ...
    function auth($uid, $pwd , $method = '')
    {
        ...
        /* If an errors was encountered, return the PEAR_Error object. */
        if (PEAR::isError($result)) {
            return $result;
        }
