                                        ...
                                        <div class="kt-portlet__body">
                                            ...
                                            <div class="kt-section kt-section--last">
                                                <div class="col-md-12 form-group">
                                                    <label>مبلغ : </label>
                                                    <input type="text" name="amount" class="form-control"
                                                           placeholder="مبلغی که پرداخت کرده اید را وارد نمایید"  autocomplete="off">
                                                    <span class="form-text text-muted">در صورتی که به هنگام ثبت taxid با مشکل مواجه شده اید، مبلغی که واریز کرده اید (باید حتما اعشاری باشد) را در اینجا وارد نمایید</span>
                                                </div>
                                                <div class="col-md-12 form-group">
