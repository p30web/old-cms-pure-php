...
class Mail_smtp extends Mail {
     ...
     *               containing a descriptive errors message on
     *               failure.
     * @access public
     */
    ...
    /**
     * Build a standardized string describing the current SMTP errors.
     *
     * @param string $text  Custom string describing the errors context.
     * @param object $error Reference to the current PEAR_Error object.
     *
     * @return string       A string describing the current SMTP errors.
     *
     * @since  1.1.7
     * @access private
     */
    function _error($text, &$error)
    {
        ...
        /* Build our standardized errors string. */
        $msg = $text;
