...
function checkserialstatus($input)
{
    switch ($input) {
        case 0 :
            echo "<span style='color:#990000;'>فروخته نشده</span>";
            break;
        case 1 :
            echo "<span style='color:#006600;'>فروخته شده</span>";
            break;
        default :
            echo "<span style='color:#990000;'>نامشخص</span>";
            break;
    }
}
...
function smssendstatus($input)
{
    switch ($input) {
        case 0 :
            echo "نام کاربری و رمز عبور صحیح نمی باشد .";
            break;
        case 1 :
            echo "ارسال موفق";
            break;
        case 2 :
            echo "اعتبار کافی نمی باشد";
            break;
        case 3 :
            echo "محدودیت ارسال روزانه";
            break;
        case 4 :
            echo "محدودیت در حجم ارسال";
            break;
        case 5 :
            echo "شماره فرستنده معتبر نیست";
            break;
        case 6 :
            echo "سامانه در حال به روز رسانی می باشد";
            break;
        case 7 :
            echo "متن پیامک شما شامل حروف فیلتر شده می باشد";
            break;
        case 8 :
            echo "عدم رسیدن متن به حداقل ارسال";
            break;
        case 9 :
            echo "ارسال از خطوط عمومی از طریق وب سرویس مقدور نمی باشد";
            break;
        case 10 :
...
function smsdeliverystatus($input)
{
    switch ($input) {
        ...
        case 5 :
            ...
            break;
        case 8 :
            echo "رسیده به مخابرات";
            break;
        case 16 :
            echo "نرسیده به مخابرات";
            break;
        case 100 :
            echo "نامشخص";
            break;
