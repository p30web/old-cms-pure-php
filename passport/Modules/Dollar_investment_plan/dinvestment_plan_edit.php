...
$db->where("id", $id);
$cols = array("*");
$fetch_investment_plan = $db->getOne("`dollar_investment_plan`", $cols);
...
//                    $handle2->clean();
        ...
        if ($db->update("dollar_investment_plan", $insert_array)) {
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="kt-portlet">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_dinvestment_plan_edit" method="post"
                                      action="dinvestment_plan_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    var KTFormControls = {
        init: function () {
            $("#form_dinvestment_plan_edit").validate({
                rules: {
                    title: {required: !0},
                    price: {required: !0},
                    status: {required: !0},
