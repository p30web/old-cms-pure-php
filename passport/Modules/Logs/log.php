                ...
                <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                    ...
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            $total_pages = $mysqli->query('SELECT COUNT(*) FROM `member_activity`')->fetch_row()[0];
                            ...
                            if ($stmt = $mysqli->prepare('SELECT * FROM `member_activity` ORDER BY id DESC LIMIT ?,?')) {
                            ...
                            <div style="font-size: 15px;display: inline;width: auto;margin-bottom: 18px;">مشاهده لاگ های یک کاربر خاص :

                                <form action="user-log.php" style="display: inline-block;">
                                    <input name="userid" type="number">
                                    <input name="table" placeholder="جدول مورد نظر رو وارد نمایید" type="text">
                            ...
                            <?php if (ceil($total_pages / $num_results_on_page) > 0): ?>
                                <ul class="pagination">
                                    <?php if ($page > 1): ?>
                                        <li class="prev"><a href="log.php?page=<?php echo $page-1 ?>">قبلی</a></li>
                                    <?php endif; ?>

                                    <?php if ($page > 3): ?>
                                        <li class="start"><a href="log.php?page=1">1</a></li>
                                        <li class="dots">...</li>
                                    <?php endif; ?>

                                    <?php if ($page-2 > 0): ?><li class="page"><a href="log.php?page=<?php echo $page-2 ?>"><?php echo $page-2 ?></a></li><?php endif; ?>
                                    <?php if ($page-1 > 0): ?><li class="page"><a href="log.php?page=<?php echo $page-1 ?>"><?php echo $page-1 ?></a></li><?php endif; ?>

                                    <li class="currentpage"><a href="log.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>

                                    <?php if ($page+1 < ceil($total_pages / $num_results_on_page)+1): ?><li class="page"><a href="log.php?page=<?php echo $page+1 ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
                                    <?php if ($page+2 < ceil($total_pages / $num_results_on_page)+1): ?><li class="page"><a href="log.php?page=<?php echo $page+2 ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

                                    <?php if ($page < ceil($total_pages / $num_results_on_page)-2): ?>
                                        <li class="dots">...</li>
                                        <li class="end"><a href="log.php?page=<?php echo ceil($total_pages / $num_results_on_page) ?>"><?php echo ceil($total_pages / $num_results_on_page) ?></a></li>
                                    <?php endif; ?>

                                    <?php if ($page < ceil($total_pages / $num_results_on_page)): ?>
                                        <li class="next"><a href="log.php?page=<?php echo $page+1 ?>">بعدی</a></li>
                                    <?php endif; ?>
                                </ul>
                            <?php endif; ?>
