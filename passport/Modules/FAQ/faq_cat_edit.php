...
$id = decrypt($_GET['id'], session_id() . "fac");
$id = GetSQLValueString($id, 'int');


$db->where("id", $id);
$cols = array("*");
$fetch_faqcat = $db->getOne("`faqcat`", $cols);
$fetch_faqcat_count = $db->count;
    ...
    if ($val->isSuccess()) {
        ...
        if ($_FILES['image']) {
            ...
            if ($handle->uploaded) {
                ...
                $handle->process('../../../Attachment/img/faqs/');
                if ($handle->processed) {
//            $handle->clean();
                    $imguploaded = 1;
                    //image upload
                    ...
                    if ($handle2->uploaded) {
                        ...
                        $handle2->process('../../../Attachment/img/faqs/thumbs/');
...
//                    $handle2->clean();
        ...
        $header =  ($headeruploaded > 0) ? $headerimgName . '.jpg' : $fetch_faqcat['header'];
        $image =  ($imguploaded > 0) ? $imgName . '.jpg' : $fetch_faqcat['image'];
        ...
        if ($db->update("faqcat", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | ویرایش دسته بندی سوالات متداول</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                ویرایش دسته بندی سوالات متداول <?php echo $fetch_faqcat['name']; ?> </h3>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات دسته بندی سوالات متداول <?php echo $fetch_faqcat['name']; ?>
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_faqcat_add" method="post"
                                      action="faq_cat_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                       value="<?php echo $fetch_faqcat['name']; ?>"
                                                       placeholder="نام را وارد کنید">
                                            </div>
                                            <div class="col-lg-4 form-group-sub">
                                                <label class="">کد یکتا:</label>
                                                <input type="text" name="code" class="form-control"
                                                       value="<?php echo $fetch_faqcat['code']; ?>"
                                                       placeholder="کد یکتا را وارد کنید">
                                            </div>
                                            <div class="col-lg-4 form-group-sub">
                                                <label class="">نام صفحه:</label>
                                                <input type="text" name="pagename" class="form-control"
                                                       value="<?php echo $fetch_faqcat['pagename']; ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="portalid" name="portalid">
                                                    ...
                                                    if ($totalRows_rssettings > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rssettings['id']; ?>" <?php if ($row_rssettings['id'] == $fetch_faqcat['portalid']) { echo 'selected'; } ?>><?php echo $row_rssettings['name']; ?></option>
                                                            <?php
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="level" name="level">
                                                    <option value="0" <?php if ($fetch_faqcat['level'] == '0') { echo 'selected'; } ?>>گروه اصلی</option>

                                                    <?php
                                                    mysqli_select_db($cn, $database_cn);
                                                    $query_faqcat = sprintf("SELECT `id`,`name` FROM `faqcat` WHERE id != %s ", $fetch_faqcat['id']);
                                                    ...
                                                    if ($totalRows_rsfaqcat > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rsfaqcat['id']; ?>" <?php if ($row_rsfaqcat['id'] == $fetch_faqcat['level']) { echo 'selected'; } ?>><?php echo $row_rsfaqcat['name']; ?></option>
                                                            <?php
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="description" id="description"
                                                              placeholder="توضیحات" rows="20"><?php echo $fetch_faqcat['description']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <input type="text" name="keywords" id="keywords"
                                                           value="<?php echo $fetch_faqcat['keywords']; ?>"
                                                           class="form-control"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <input type="text" name="style" class="form-control"
                                                       value="<?php echo $fetch_faqcat['style']; ?>"
                                        ...
                                        <div class="form-group form-group-last row">
                                            ...
                                            <div class="col-lg-3 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="memtype" <?php if ($fetch_faqcat['memtype'] === '0') echo 'checked'; ?> value="0"> همه
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="memtype" <?php if ($fetch_faqcat['memtype'] === '1') echo 'checked'; ?> value="1">کاربران
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_faqcat['status'] === '1') echo 'checked'; ?>  value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_faqcat['status'] === '0') echo 'checked'; ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinhome" <?php if ($fetch_faqcat['showinhome'] === '0') echo 'checked'; ?> value="0"> خیر
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinhome" <?php if ($fetch_faqcat['showinhome'] === '1') echo 'checked'; ?> value="1">بلی
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinmenu" <?php if ($fetch_faqcat['showinmenu'] === '0') echo 'checked'; ?> value="0"> خیر
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinmenu" <?php if ($fetch_faqcat['showinmenu'] === '1') echo 'checked'; ?> value="1">بلی
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
