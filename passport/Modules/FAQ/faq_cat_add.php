...
//                    $handle2->clean();
        ...
        $header =  ($headeruploaded > 0) ? $headerimgName . '.jpg' : null;
        ...
        if ($db->insert("faqcat", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | افزودن دسته بندی سوالات متداول</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                افزودن دسته بندی سوالات متداول </h3>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات دسته بندی سوالات متداول جدید
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_faqcat_add" method="post"
                                      action="faq_cat_add.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="level" name="level">
                                                    ...
                                                    <?php
                                                    mysqli_select_db($cn, $database_cn);
                                                    $query_faqcat = sprintf("SELECT `id`,`name` FROM `faqcat` ");
                                                    ...
                                                    if ($totalRows_rsfaqcat > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rsfaqcat['id']; ?>"><?php echo $row_rsfaqcat['name']; ?></option>
                                                            <?php
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="description" id="description"
                                                              placeholder="توضیحات" rows="20"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-3 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="memtype" checked value="0"> همه
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="memtype" value="1">کاربران
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
