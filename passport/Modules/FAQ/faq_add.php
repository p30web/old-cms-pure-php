...
<head>
    ...
    <title>Rahaaa | افزودن سوالات</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="kt-portlet">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_faq_add" method="post"
                                      action="faq_add.php" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-12 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="category" name="category">
                                                    ...
                                                    if ($totalRows_rsfaqcat > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rsfaqcat['code']; ?>"><?php echo $row_rsfaqcat['name']; ?></option>
                                                            <?php
