...
<head>
    ...
    <title>Rahaaa | پلن های سرمایه گذاری دوج کوین</title>
</head>
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                پلن های سرمایه گذاری دوج کوین</h3>
				...
				<i class="kt-font-brand flaticon2-back"></i>
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    <div class="kt-portlet__head-actions">
                                        <?php
                                        if (in_array("investment_plan_add", $privilegeslist)) echo '<a href="investment_plan_add.php" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-plus"></i>رکورد جدید</a>';
                                        ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable"
                                ...
                                $query_investment_plan = sprintf("SELECT * FROM `investment_plan` ORDER BY id ASC");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <?php if (in_array("change_status", $privilegeslist)) { ?><a
                                                            class="dropdown-item"
                                                            href="<?php ?>../../change_status.php?table=<?php echo encrypt('investment_plan', session_id() . "sts"); ?>&field=<?php echo encrypt('status', session_id() . "sts"); ?>&id=<?php echo encrypt($row_investment_plan['id'], session_id() . "sts"); ?>">
                                                        ...
                                                        <?php if (in_array("investment_plan_delete", $privilegeslist)) { ?><a
                                                            ...
                                                            href="investment_plan_delete.php?id=<?php echo encrypt($row_investment_plan['id'], session_id() . "inv"); ?>">
                                                ...
                                                <?php if (in_array("investment_plan_edit", $privilegeslist)) { ?>
                                                    <a href="investment_plan_edit.php?id=<?php echo encrypt($row_investment_plan['id'], session_id() . "inv"); ?>"
