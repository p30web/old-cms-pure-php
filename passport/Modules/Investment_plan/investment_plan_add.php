...
//                    $handle2->clean();
        ...
        if ($db->insert("investment_plan", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | افزودن پلن جدید</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="kt-portlet">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_investment_plan_add" method="post"
                                      action="investment_plan_add.php" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    var KTFormControls = {
        init: function () {
            $("#form_investment_plan_add").validate({
                rules: {
                    title: {required: !0},
                    price: {required: !0},
                    status: {required: !0},
