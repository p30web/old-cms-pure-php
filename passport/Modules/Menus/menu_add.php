...
if (!empty($_POST)) {
    ...
    if ($val->isSuccess()) {
        ...
        if ($db->insert("menus", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | افزودن منو جدید</title>
</head>
<!-- end::Head -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="kt-portlet">
                                ...
                                <form class="kt-form kt-form--label-right" id="form_menu_add" method="post"
                                      action="menu_add.php" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="parent_id" name="parent_id">
                                                    <option value="" selected>-- منو والد را انتخاب کنید --</option>
                                                    ...
                                                    if ($totalRows_rsmenus > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rsmenus['id']; ?>"><?php echo $row_rsmenus['title']; ?></option>
                                                            <?php
