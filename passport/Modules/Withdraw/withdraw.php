...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Rahaaa | درخواست های برداشت</title>
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                لیست درخواست برداشت کاربران</h3>
                    ...
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable"
                                ...
                                $query_investment_plan = sprintf("SELECT * FROM `withdraw` ORDER BY id ASC");
                                ...
                                if ($totalRows_investment_plan > 0) {
                                    do {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row_investment_plan['amount'] - $row_investment_plan['member_fee']; ?></td>
                                            <td><?php echo $row_investment_plan['wallet']; ?></td>
                                            <td><?php echo (is_null($row_investment_plan['type'])) ? "دوج کوین" : 'دلار'; ?></td>
                                            <td><?php echo $row_investment_plan['created_at']; ?></td>
                                            <td><?php
                                                if ($row_investment_plan['status'] == '1') {
                                                    echo '<span class="kt-badge kt-badge--success kt-badge--inline kt-badge--pill">واریز شده</span>';
                                                } elseif ($row_investment_plan['status'] == '0') {
                                                    echo '<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill">درصف</span>';
                                                }
                                                elseif ($row_investment_plan['status'] == '3') {
                                                    echo '<span class="kt-badge kt-badge--danger kt-badge--inline kt-badge--pill">برگشت خورده</span>';
                                                }
                                                else {
                                            ...
                                            <td>
													<span class="dropdown">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item text-danger" onClick="return confirm('آیا مطمئنید می خواهید درخواست برداشت را برگشت بزنید؟');" href="withdraw_delete.php?id=<?php echo encrypt($row_investment_plan['id'], session_id() . "inv"); ?>">
																<i class="la la-trash text-danger "></i> برگشت
															</a>
															<a class="dropdown-item"
                                                               href="../../change_status.php?table=<?php echo encrypt('withdraw', session_id() . "sts"); ?>&field=<?php  echo encrypt('status', session_id() . "sts"); ?>&id=<?php echo encrypt($row_investment_plan['id'], session_id() . "sts"); ?>">
																<i class="la la-toggle-on"></i> واریز
															</a>
														</div>
													</span>
