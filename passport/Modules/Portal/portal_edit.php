...
$id = decrypt($_GET['id'], session_id() . "prt");
$id = GetSQLValueString($id, 'int');


$db->where("id", $id);
$cols = array("*");
$fetch_settings = $db->getOne("`settings`", $cols);
$fetch_settings_count = $db->count;
...
//                    }
        ...
        $fax = GetSQLValueString($_POST['fax'], 'def');
        ...
        $logo = ($imguploaded > 0) ? $imgName . '.png' : $fetch_settings['logo'];
        $logo2 = ($imguploaded2 > 0) ? $imgName2 . '.png' : $fetch_settings['logo2'];
        $favicon = ($imguploaded3 > 0) ? $imgName3 . '.ico' : $fetch_settings['favicon'];
        ...
        if ($db->update("settings", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | ویرایش پرتال</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                ویرایش پرتال <?php echo $fetch_settings['name']; ?> </h3>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات پرتال <?php echo $fetch_settings['name']; ?>
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_portal_add" method="post" action="portal_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                                    <div class="kt-portlet__body">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="keywords" id="keywords" class="form-control"
                                                           ...
                                                           value="<?php echo $fetch_settings['keywords']; ?>"
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="copyright" id="copyright" class="form-control"
                                                           ...
                                                           value="<?php echo $fetch_settings['copyright']; ?>"
                                                           aria-describedby="basic-addon1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="description" placeholder="توضیحات مربوط به فعالیت وبسایت یا اپلیکیشن" rows="8"><?php echo $fetch_settings['description']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="contacttitle" class="form-control"
                                                       value="<?php echo $fetch_settings['contacttitle']; ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="contacttext" placeholder="متن تماس با ما برای نمایش در سایت" rows="12"><?php echo $fetch_settings['contacttext']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group form-group-last row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="can_sees" <?php if ($fetch_settings['can_sees'] === 0) echo 'checked'; ?> value="0">
                                                        عدم نمایش
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="can_sees" <?php if ($fetch_settings['can_sees'] === 2) echo 'checked'; ?> value="2">
                                                        فقط کاربران (مدیران)
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="can_sees" <?php if ($fetch_settings['can_sees'] === 1) echo 'checked'; ?> value="1">
                                                        نمایش به همه
                                                        <span></span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_settings['status'] === '1') echo 'checked'; ?> value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_settings['status'] === '0') echo 'checked'; ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
