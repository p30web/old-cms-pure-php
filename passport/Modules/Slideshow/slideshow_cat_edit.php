...
$id = decrypt($_GET['id'], session_id() . "slc");
$id = GetSQLValueString($id, 'int');


$db->where("id", $id);
$cols = array("*");
$fetch_slideshowcat = $db->getOne("`slideshowcat`", $cols);
$fetch_slideshowcat_count = $db->count;
...
//        $header = GetSQLValueString($_POST['header'], 'def');
        ...
        $image = ($imguploaded > 0) ? $imgName . '.jpg' : $fetch_slideshowcat['image'];
...
//            "header" => $header ,
        ...
        if ($db->update("slideshowcat", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | ویرایش اسلایدر</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                ویرایش اسلایدر  <?php echo $fetch_slideshowcat['name']; ?> </h3>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات <?php echo $fetch_slideshowcat['name']; ?>
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_slideshowcat_edit" method="post"
                                      action="slideshow_cat_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                       value="<?php echo $fetch_slideshowcat['name']; ?>"
                                                       placeholder="نام را وارد کنید">
                                            </div>
                                            <div class="col-lg-6 form-group-sub">
                                                <label class="">کد یکتا:</label>
                                                <input type="text" name="code" class="form-control"
                                                       value="<?php echo $fetch_slideshowcat['code']; ?>"
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="portalid" name="portalid">
                                                    ...
                                                    if ($totalRows_rssettings > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rssettings['id']; ?>" <?php if ($row_rssettings['id'] == $fetch_slideshowcat['portalid']) { echo 'selected'; } ?>><?php echo $row_rssettings['name']; ?></option>
                                                            <?php
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="description"  id="description" placeholder="توضیحات" rows="20"><?php echo $fetch_slideshowcat['description']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="params"  id="params" placeholder="پارامتر ها" rows="5"><?php echo $fetch_slideshowcat['params']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <input type="text" name="style" class="form-control"
                                                       value="<?php echo $fetch_slideshowcat['style']; ?>"
                                                       placeholder="استایل را وارد کنید">
                                            </div>
                                            <div class="col-lg-4 form-group-sub">
                                                <label class="">کلمات کلیدی:</label>
                                                <input type="text" name="keywords" class="form-control"
                                                       value="<?php echo $fetch_slideshowcat['keywords']; ?>"
                                            ...
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="input-group  bootstrap-touchspin bootstrap-touchspin-injected">
                                                    <input id="sort" type="text"
                                                           ...
                                                           value="<?php echo $fetch_slideshowcat['sort']; ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_slideshowcat['status'] === '1') echo 'checked'; ?>  value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_slideshowcat['status'] === '0') echo 'checked'; ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="memtype" <?php if ($fetch_slideshowcat['memtype'] === '0') echo 'checked'; ?> value="0"> عکس
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="memtype" <?php if ($fetch_slideshowcat['memtype'] === '1') echo 'checked'; ?> value="1">فیلم
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group form-group-last row">
                                            ...
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinmenu" <?php if ($fetch_slideshowcat['showinmenu'] === '1') echo 'checked'; ?> value="1"> بلی
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinmenu" <?php if ($fetch_slideshowcat['showinmenu'] === '0') echo 'checked'; ?> value="0">خیر
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinhome" <?php if ($fetch_slideshowcat['showinhome'] === '1') echo 'checked'; ?> value="1"> بلی
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinhome" <?php if ($fetch_slideshowcat['showinhome'] === '0') echo 'checked'; ?> value="0">خیر
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    var KTFormControls = {
        init: function () {
            $("#form_slideshowcat_edit").validate({
                rules: {
                    name: {required: !0},
                    code: {required: !0},
                    status: {required: !0},
