...
//            "voffset" => $voffset,
        ...
        if ($db->insert("slideshow", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | افزودن اسلاید جدید</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="kt-portlet">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_slideshow_add" method="post"
                                      action="slideshow_add.php" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="category" name="category">
                                                    ...
                                                    if ($totalRows_slideshowcat > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_slideshowcat['code']; ?>"><?php echo $row_slideshowcat['name']; ?></option>
                                                            <?php
