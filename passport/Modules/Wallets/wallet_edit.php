...
$db->where("id", $id);
$cols = array("*");
$fetch_wallets = $db->getOne("`wallets`", $cols);
$fetch_wallets_count = $db->count;
...
if (!empty($_POST)) {
	...
	if ($val->isSuccess()) {
		...
		$logo = ($imguploaded > 0) ? $imgName . '.png' : $fetch_wallets['logo'];
		...
		$ac_wallet = GetSQLValueString($_POST['ac_wallet'], 'def');
		...
		if ($db->update("wallets", $insert_array)) {
...
<html lang="en" direction="rtl" style="direction: rtl;">
	...
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>Rahaaa | ویرایش کیف پول</title>
	</head>
	<!-- end::Head -->
							...
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									...
									<h3 class="kt-subheader__title">
										ویرایش کیف پول <?php echo $fetch_wallets['name']; ?> </h3>
										...
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													مشخصات کیف پول <?php echo $fetch_wallets['name']; ?>
												</h3>
											</div>
										</div>
										<!--begin::Form-->
										<form class="kt-form kt-form--label-right" id="form_wallet_add" method="post"
											  action="wallet_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
											<div class="kt-portlet__body">
												...
												<div class="form-group row">
													<div class="col-lg-4 form-group-sub">
														...
														<input type="text" name="name" class="form-control"
															   value="<?php echo $fetch_wallets['name']; ?>"
															   placeholder="عنوان را وارد کنید">
													</div>
													<div class="col-lg-4 form-group-sub">
														<label class="">نام انگلیسی:</label>
														<input type="text" name="en_name" class="form-control"
															   value="<?php echo $fetch_wallets['en_name']; ?>"
													...
													<div class="col-lg-4 form-group-sub">
														...
														<select class="form-control kt-select2" id="unit_id" name="unit_id">
															...
															if ($totalRows_rsunit > 0) {
																...
																do {
															?>
															<option value="<?php echo $row_rsunit['id']; ?>" <?php if ($row_rsunit['id'] == $fetch_wallets['unit_id']) { echo 'selected'; } ?>><?php echo $row_rsunit['name_fa']; ?></option>
															<?php
												...
												<div class="form-group row">
													<div class="col-lg-12">
														...
														<div class="kt-input-icon">
															<textarea class="form-control" name="description" placeholder="توضیحات کیف پول" rows="8"><?php echo $fetch_wallets['description']; ?></textarea>
														</div>
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group form-group-last row">
													<div class="col-lg-4 form-group-sub">
														...
														<div class="kt-radio-inline">
															<label class="kt-radio kt-radio--solid">
																<input type="radio" name="balance_type" <?php if ($fetch_wallets['balance_type'] === 1) echo 'checked'; ?>  value="1"> دستی
																<span></span>
															</label>
															<label class="kt-radio kt-radio--solid">
																<input type="radio" name="balance_type" <?php if ($fetch_wallets['balance_type'] === 0) echo 'checked'; ?> value="0">اتوماتیک از Api
																<span></span>
															</label>
														</div>
													</div>
													<div class="col-lg-4 form-group-sub">
														...
														<div class="kt-radio-inline">
															<label class="kt-radio kt-radio--solid">
																<input type="radio" name="status" <?php if ($fetch_wallets['status'] === '1') echo 'checked'; ?>  value="1"> فعال
																<span></span>
															</label>
															<label class="kt-radio kt-radio--solid">
																<input type="radio" name="status" <?php if ($fetch_wallets['status'] === '0') echo 'checked'; ?> value="0"> غیر فعال
																<span></span>
															</label>
														</div>
													</div>
													<div class="col-lg-4 form-group-sub">
														...
														<div class="input-group  bootstrap-touchspin bootstrap-touchspin-injected">
															<input id="sort" type="text"
																   ...
																   value="<?php echo $fetch_wallets['sort']; ?>"
