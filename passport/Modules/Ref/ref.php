...
<html lang="en" direction="rtl" style="direction: rtl;">
	...
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>Rahaaa | زیرمجموعه ها</title>
								...
								<div class="kt-portlet__body">
									...
									<table class="table table-striped- table-bordered table-hover table-checkable"
										...
										<tbody>
											...
											$query_investment_plan = sprintf("SELECT * FROM `members` WHERE `parent_id` > '0' ORDER BY id ASC");
											...
											<tr>
												...
												<td><a href="/admin/Modules/Members/member_edit.php?id=<?php echo encrypt($row_investment_plan['id'], session_id() . "mem"); ?>"><?php echo $row_investment_plan['firstname']; ?> <?php echo $row_investment_plan['lastname']; ?></a></td>
												<td><a href="/admin/Modules/Members/member_edit.php?id=<?php echo encrypt($row_investment_plan['parent_id'], session_id() . "mem"); ?>">
													<?php
													mysqli_select_db($cn, $database_cn);
													$query_rsunits = sprintf("SELECT * FROM `members` WHERE id= %d", $row_investment_plan['parent_id']);
												...
												<td><?php echo $row_investment_plan['refIncome']; ?></td>
