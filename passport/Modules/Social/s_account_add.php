...
//                    $handle2->clean();
        ...
        if ($db->insert("social_sccounts", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | افزودن شبکه اجتماعی جدید</title>
</head>
<!-- end::Head -->
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات شبکه اجتماعی جدید
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_social_a_add" method="post"
                                      action="s_account_add.php" enctype="multipart/form-data">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group form-group-last row">
                                            ...
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="type" checked value="0"> عمومی
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="type" value="1">خصوصی
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
