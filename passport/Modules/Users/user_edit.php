...
//                    $handle2->clean();
        ...
        $img = ($imguploaded > 0) ? $imgName . '.jpg' : $fetch_users['image'];
...
<head>
    ...
    <title>Rahaaa | ویرایش کاربران</title>
</head>
<!-- end::Head -->
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات <?php echo $fetch_users['name']; ?>
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_user_add" method="post"
                                      action="user_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                       value="<?php echo $fetch_users['name']; ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="portalid" name="portalid">
                                                    ...
                                                    if ($totalRows_rssettings > 0) {
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rssettings['id']; ?>" <?php if ($row_rssettings['id'] == $fetch_users['portalid']) { echo 'selected'; } ?>><?php echo $row_rssettings['name']; ?></option>
                                                            <?php
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_apps_user_add_avatar">
                                                    <div class="kt-avatar__holder" style="background-image:  url(<?php echo '../../../Attachment/img/users/' . $fetch_users['image']; ?>); background-size: cover;"></div>
                                                    <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="تغییر عکس">
                                                        <i class="fa fa-pen"></i>
                                            ...
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_users['status'] === '1') echo 'checked'; ?> value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_users['status'] === '0') echo 'checked'; ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
