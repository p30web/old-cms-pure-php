                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            تغییر رمز
                                            عبور <?php echo $fetch_users['name']; ?>
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_user_changepass" method="post"
                                      action="user_change_pass.php?id=<?php echo $_GET['id']; ?>"
