...
$db->where("id", $id);
$cols = array("*");
$fetch_settings_param = $db->getOne("`settings_param`", $cols);
$fetch_settings_param_count = $db->count;
...
if (!empty($_POST)) {
    ...
    if ($val->isSuccess()) {
        ...
        if ($db->update("settings_param", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | ویرایش پارامتر</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                ویرایش  پارامتر <?php echo $fetch_settings_param['name']; ?> </h3>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات پارامتر <?php echo $fetch_settings_param['name']; ?>
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="kt_form_settings_param_add" method="post" action="settings_param_edit.php?id=<?php echo $_GET['id']; ?>"">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                       value="<?php echo $fetch_settings_param['name']; ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <input type="text" name="code" class="form-control"
                                                       value="<?php echo $fetch_settings_param['code']; ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="value" placeholder="مقدار پارامتر" rows="8"><?php echo $fetch_settings_param['value']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
