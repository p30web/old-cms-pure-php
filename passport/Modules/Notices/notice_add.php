...
if (!empty($_POST)) {
    ...
    if ($val->isSuccess()) {
        ...
        if ($db->insert("p30web_notic", $insert_array)) {
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>ایجاد اطلاعیه جدید</title>
</head>
<!-- end::Head -->
                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">مشخصات اطلاعیه جدید</h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_post_add" method="post"
                                      action=" notice_add.php" enctype="multipart/form-data">
                                    ...
                                    <div class="kt-portlet__foot">
                                        <div class="kt-form__actions">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button type="submit" class="btn btn-primary">ایجاد اطلاعیه جدید
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
