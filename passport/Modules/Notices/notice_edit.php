...
$db->where("id", $id);
$cols = array("*");
$fetch_notices = $db->getOne("p30web_notic", $cols);
$fetch_notices_count = $db->count;
...
if (!empty($_POST)) {
    ...
    if ($val->isSuccess()) {
        ...
        if ($db->update("p30web_notic", $insert_array)) {
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>بروز رسانی اطلاعیه جدید</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="notices.php" class="kt-subheader__breadcrumbs-link">
                                    اطلاعیه ها </a>
                            ...
                            <div class="kt-portlet">
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">مشخصات اطلاعیه</h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_notice_edite" method="post"
                                      action="notice_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                <label>عنوان:</label>
                                                <input type="text" name="title" class="form-control" placeholder="عنوان را وارد کنید" value="<?php echo $fetch_notices['title']; ?>">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_notices['status'] === '1') { echo 'checked'; } ?> value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_notices['status'] === '0') { echo 'checked'; } ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="kt-portlet__foot">
                                        <div class="kt-form__actions">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <button type="submit" class="btn btn-primary">بروز رسانی اطلاعیه
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
