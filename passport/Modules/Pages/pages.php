...
<head>
    ...
    <title>Rahaaa | مدیریت صفحات</title>
				...
				<i class="kt-font-brand flaticon2-back"></i>
                            ...
                            <div class="kt-portlet__head-toolbar">
                                <div class="kt-portlet__head-wrapper">
                                    <div class="kt-portlet__head-actions">
                                        <?php
                                        if (in_array("page_add", $privilegeslist)) echo '<a href="page_add.php" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-plus"></i>رکورد جدید</a>';
                                        ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable"
                                ...
                                mysqli_select_db($cn, $database_cn);
                                $query_rspages= sprintf("SELECT * FROM `pages` ORDER BY id ASC");
                                $rspages = mysqli_query($cn, $query_rspages) or die(mysqli_error($cn));
                                ...
                                if ($totalRows_rspages > 0) {
                                    do {
                                        ...
                                        <tr>
                                            <td><?php echo $row_rspages['id']; ?></td>
                                            <td><?php echo $row_rspages['title']; ?></td>
                                            <td><?php echo $row_rspages['code']; ?></td>
                                            <td><span class="kt-badge kt-badge--primary kt-badge--dot"></span>&nbsp;<span class="kt-font-bold kt-font-primary"><?php echo $row_rspages['lastupdate']; ?></span></td>

                                            <td><?php
                                                if ($row_rspages['status'] == '1') {
                                                    echo '<span class="kt-badge kt-badge--success kt-badge--inline kt-badge--pill">فعال</span>';
                                                } elseif ($row_rspages['status'] == '0') {
                                            ...
                                            <td>
                                                <span class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <?php if (in_array("change_status", $privilegeslist)) { ?><a
                                                            class="dropdown-item"
                                                            href="<?php ?>../../change_status.php?table=<?php echo encrypt('pages', session_id() . "sts"); ?>&field=<?php echo encrypt('status', session_id() . "sts"); ?>&id=<?php echo encrypt($row_rspages['id'], session_id() . "sts"); ?>">
                                                        ...
                                                        <?php if (in_array("menu_delete", $privilegeslist)) { ?><a
                                                            ...
                                                            href="page_delete.php?id=<?php echo encrypt($row_rspages['id'], session_id() . "pge"); ?>">
                                                ...
                                                <?php if (in_array("menu_edit", $privilegeslist)) { ?>
                                                    <a href="page_edit.php?id=<?php echo encrypt($row_rspages['id'], session_id() . "pge"); ?>"
                                                ...
                                                if($Site_Information_patam['pages']) {
                                                    ?>
                                                    <a href="<?php echo $Site_Information_patam['website_url'].$Site_Information_patam['pages'].'='.$row_rspages['code']; ?>"
                                                       class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                       target="_blank"
                                                       title="نمایش">
