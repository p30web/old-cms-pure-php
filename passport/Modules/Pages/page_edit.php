...
$id = decrypt($_GET['id'], session_id() . "pge");
...
if (!empty($_POST)) {
    ...
    if ($val->isSuccess()) {
        ...
        if ($db->update("pages", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | ویرایش صفحه</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                ویرایش صفحه <?php echo $fetch_pages['title']; ?> </h3>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات صفحه <?php echo $fetch_pages['title']; ?>
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_page_edit" method="post"
                                      action="page_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="index_text"  id="index_text" placeholder="متن صفحه با ما برای نمایش در صفحه اصلی" rows="20"><?php echo $fetch_pages['index_text']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="text"  id="text" placeholder="متن صفحه با ما برای نمایش در سایت" rows="20"><?php echo $fetch_pages['text']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <input type="text" name="keywords" id="keywords"
                                                           class="form-control"
                                                           value="<?php echo $fetch_pages['keywords']; ?>"
                                            ...
                                            <div class="col-lg-12 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="portalid" name="portalid">
                                                    ...
                                                    if ($totalRows_rssettings > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rssettings['id']; ?>" <?php if ($row_rssettings['id'] == $fetch_pages['portalid']) { echo 'selected'; } ?>><?php echo $row_rssettings['name']; ?></option>
                                                            <?php
                                        ...
                                        <div class="form-group form-group-last row">
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_pages['status'] === '1') echo 'checked'; ?> value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_pages['status'] === '0') echo 'checked'; ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="type" <?php if ($fetch_pages['type'] === '0') echo 'checked'; ?> value="0"> اصلی
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="type" <?php if ($fetch_pages['type'] === '1') echo 'checked'; ?> value="1">فرعی
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
