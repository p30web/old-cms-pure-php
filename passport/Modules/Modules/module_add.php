...
if (!empty($_POST)) {
    ...
    if ($val->isSuccess()) {
        ...
        if ($db->insert("apps", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | افزودن ماژول جدید</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="kt-portlet">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="kt_form_module" method="post" action="module_add.php">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="style" placeholder="کلاس آیکون یا svg" rows="8"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="type" checked value="collapse">
                                                        collapse
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
