...
$id = decrypt($_GET['id'], session_id() . "uti");
$id = GetSQLValueString($id, 'int');

mysqli_select_db($cn, $database_cn);
$query_rsapp_modules = sprintf("SELECT * FROM app_modules WHERE `id` = $id");
$rsapp_modules = mysqli_query($cn, $query_rsapp_modules) or die(mysqli_error($cn));
$row_rsapp_modules = mysqli_fetch_assoc($rsapp_modules);
$totalRows_rsapp_modules = mysqli_num_rows($rsapp_modules);
...
if (!empty($_POST)) {
    ...
    if ($val->isSuccess()) {
        ...
        if ($db->update("app_modules", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | ویرایش ابزار </title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                ویرایش ابزار <?php echo $row_rsapp_modules['name']; ?> </h3>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="kt-portlet">
                                ...
                                <form class="kt-form kt-form--label-right" id="kt_form_module" method="post"
                                      action="module_utility_edit.php?id=<?php echo $_GET['id']; ?>">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <input type="text" name="name" class="form-control"
                                                       value="<?php echo $row_rsapp_modules['name']; ?>"
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="cat" name="cat">
                                                    ...
                                                    if ($totalRows_rsappsmodules > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rsappsmodules['id']; ?>" <?php if ($row_rsapp_modules['cat'] === $row_rsappsmodules['id']) echo 'selected'; ?> ><?php echo $row_rsappsmodules['name']; ?></option>
                                                            <?php
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <input type="text" name="path" class="form-control"
                                                       value="<?php echo $row_rsapp_modules['path']; ?>"
                                                       placeholder="مسیر را وارد کنید">
                                            </div>
                                            <div class="col-lg-6 form-group-sub">
                                                <label class="">صفحه:</label>
                                                <input type="text" name="page" class="form-control"
                                                       value="<?php echo $row_rsapp_modules['page']; ?>"
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="description"
                                                              placeholder="توضیحات را بنویسید" rows="8"><?php echo $row_rsapp_modules['description']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group form-group-last row">
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinmenu" <?php if ($row_rsapp_modules['showinmenu'] === '1') echo 'checked'; ?> value="1">
                                                        بلی
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="showinmenu" <?php if ($row_rsapp_modules['showinmenu'] === '0') echo 'checked'; ?> value="0"> خیر
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($row_rsapp_modules['status'] === '1') echo 'checked'; ?> value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($row_rsapp_modules['status'] === '0') echo 'checked'; ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 form-group-sub">
                                                ...
                                                <div class="input-group  bootstrap-touchspin bootstrap-touchspin-injected">
                                                    <input id="kt_touchspin_4" type="text"
                                                           value="<?php echo $row_rsapp_modules['sort']; ?>"
