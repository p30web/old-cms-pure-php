...
$id = decrypt($_GET['id'], session_id() . "pst");
$id = GetSQLValueString($id, 'int');


$db->where("id", $id);
$cols = array("*");
$fetch_posts = $db->getOne("`posts`", $cols);
$fetch_posts_count = $db->count;
...
//        $user = GetSQLValueString($_POST['user'], "def");
        ...
        $image = ($imguploaded > 0) ? $imgName . '.jpg' : $fetch_posts['image'];
...
//            "user" => $_SESSION['user_id'],
        ...
        if ($db->update("posts", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | ویرایش مطالب</title>
</head>
<!-- end::Head -->
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <h3 class="kt-subheader__title">
                                ویرایش مطالب <?php echo $fetch_posts['title']; ?> </h3>
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات مطلب <?php echo $fetch_posts['title']; ?>
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_post_edit" method="post"
                                      action="post_edit.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                                    <div class="kt-portlet__body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <input type="text" name="title" class="form-control"
                                                       value="<?php echo $fetch_posts['title']; ?>"
                                                       placeholder="عنوان را وارد کنید">
                                            </div>
                                            <div class="col-lg-6 form-group-sub">
                                                <label class="">عنوان فرعی:</label>
                                                <input type="text" name="subtitle" class="form-control"
                                                       value="<?php echo $fetch_posts['title2']; ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="category" name="category[]"
                                                        multiple="multiple">
                                                    <option value="0" <?php if (in_array('0', explode(",", $fetch_posts['category']))) { echo 'selected'; } ?>>گروه اصلی</option>
                                                    ...
                                                    if ($totalRows_post_category > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_post_category['code']; ?>" <?php if (in_array($row_post_category['code'], explode(",", $fetch_posts['category']))) { echo 'selected'; } ?>><?php echo $row_post_category['name']; ?></option>
                                                            <?php
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="special" name="special">
                                                    <option value="0" <?php if ($fetch_posts['special'] == '0') { echo 'selected'; } ?>>معمولی</option>
                                                    <option value="1" <?php if ($fetch_posts['special'] == '1') { echo 'selected'; } ?>>ویژه</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="comment" name="comment">
                                                    <option value="0" <?php if ($fetch_posts['comment'] == '0') { echo 'selected'; } ?>>بدون نظر</option>
                                                    <option value="1" <?php if ($fetch_posts['comment'] == '1') { echo 'selected'; } ?>>نظر با تائيد</option>
                                                    <option value="2" <?php if ($fetch_posts['comment'] == '2') { echo 'selected'; } ?>>نظر بدون تائيد</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="commentview" <?php if ($fetch_posts['commentview'] == '1') { echo 'checked'; } ?> value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="commentview" <?php if ($fetch_posts['commentview'] == '0') { echo 'checked'; } ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="portalid" name="portalid">
                                                    ...
                                                    if ($totalRows_rssettings > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_rssettings['id']; ?>" <?php if ($fetch_posts['portalid'] === $row_rssettings['id']) { echo 'selected'; } ?>><?php echo $row_rssettings['name']; ?></option>
                                                            <?php
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="memtype" name="memtype">
                                                    <option value="0" <?php if ($fetch_posts['memtype'] === '0') { echo 'selected'; } ?>>همه</option>
                                                    <option value="1" <?php if ($fetch_posts['memtype'] === '1') { echo 'selected'; } ?>>اعضا</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <input type="text" name="imagealt" class="form-control"
                                                       value="<?php echo $fetch_posts['imagealt']; ?>"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-6 form-group-sub row">
                                                ...
                                                <span class="kt-switch kt-switch--outline kt-switch--icon kt-switch--success">
                                                    <label>
                                                        <input type="checkbox" <?php if ($fetch_posts['showinhome'] === '1') { echo 'checked'; } ?> name="showinhome">
                                                        <span></span>
                                                    </label>
                                                </span>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="mintext" id="mintext"
                                                              placeholder="متن کوتاه" rows="5"><?php echo $fetch_posts['mintext']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="abstract" id="abstract"
                                                              placeholder="خلاصه مطلب" rows="20"><?php echo $fetch_posts['abstract']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="kt-input-icon">
                                                    <textarea class="form-control" name="textbody" id="textbody"
                                                              placeholder="متن کامل مطلب" rows="20"><?php echo $fetch_posts['textbody']; ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="kt-input-icon">
                                                    <input type="text" name="keywords" id="keywords"
                                                           class="form-control"
                                                           value="<?php echo $fetch_posts['keywords']; ?>"
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <div class="input-group  bootstrap-touchspin bootstrap-touchspin-injected">
                                                    <input id="sort" type="text"
                                                           ...
                                                           value="<?php echo $fetch_posts['sort']; ?>"
                                        ...
                                        <div class="form-group form-group-last row">
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_posts['status'] === '1') { echo 'checked'; } ?> value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_posts['status'] === '0') { echo 'checked'; } ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_posts['status'] === '2') { echo 'checked'; } ?> value="2"> در حال بررسی
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="status" <?php if ($fetch_posts['status'] === '3') { echo 'checked'; } ?> value="3"> پیش نویس
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <div class="kt-radio-inline">
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="view" <?php if ($fetch_posts['view'] === '1') { echo 'checked'; } ?>  value="1"> فعال
                                                        <span></span>
                                                    </label>
                                                    <label class="kt-radio kt-radio--solid">
                                                        <input type="radio" name="view" <?php if ($fetch_posts['view'] === '0') { echo 'checked'; } ?> value="0"> غیر فعال
                                                        <span></span>
                                                    </label>
                                                </div>
                                            </div>
