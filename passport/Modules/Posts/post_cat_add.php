...
//                    $handle2->clean();
        ...
        if ($db->insert("post_category", $insert_array)) {
...
<head>
    ...
    <title>Rahaaa | افزودن گروه مطالب</title>
</head>
<!-- end::Head -->
                                ...
                                <div class="kt-portlet__head">
                                    <div class="kt-portlet__head-label">
                                        <h3 class="kt-portlet__head-title">
                                            مشخصات گروه مطالب جدید
                                        </h3>
                                    </div>
                                </div>
                                <!--begin::Form-->
                                <form class="kt-form kt-form--label-right" id="form_post_cat_add" method="post"
                                      action="post_cat_add.php" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6 form-group-sub">
                                                ...
                                                <select class="form-control kt-select2" id="level" name="level">
                                                    ...
                                                    if ($totalRows_post_category > 0) {
                                                        ...
                                                        do {
                                                            ?>
                                                            <option value="<?php echo $row_post_category['id']; ?>"><?php echo $row_post_category['name']; ?></option>
                                                            <?php
