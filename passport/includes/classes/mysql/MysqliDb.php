...
class MysqliDb
{
    ...
    /**
     * Variable which holds last statement errors
     * @var string
     */
    protected $_stmtError;

    /**
     * Variable which holds last statement errors code
     * @var int
     */
    ...
    public function delete($tableName, $numRows = null)
    {
        ...
        return ($stmt->affected_rows > -1);	//	affected_rows returns 0 if nothing matched where statement, or required updating, -1 if errors
    }
    ...
    protected function _dynamicBindResults(mysqli_stmt $stmt)
    {
        ...
        // if $meta is false yet sqlstate is true, there's no sql errors but the query is
     ...
     * and throws an errors if there was a problem.
     *
     * @return mysqli_stmt
     * @throws Exception
     */
    ...
    /**
     * Method returns mysql errors code
     * @return int
     */
