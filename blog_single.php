...
$id = GetSQLValueString($_GET['post'], 'int');
...
<head>
    <title>مشاهده مطلب - <?php echo $fetch_posts['title']; ?></title>
...
<header id="header">
    <div class="container">
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <!-- Logo -->
                <a class="logo" href="index.php"><img style="width: 130px;"
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <div class="blog-single">
                        <div class="post-media">
                            <div class="date"><?php echo substr($fetch_posts['modified_at'], 8, 2); ?>
                                <span><?php echo monthname(substr($fetch_posts['modified_at'], 5, 2)); ?></span>
                            </div>
                            <a href="#"><img src="<?php
                                if ($fetch_posts['image']) {
                                    echo 'Attachment/img/posts/' . $fetch_posts['image'];
                                } else {
                                    echo 'Attachment/img/default.png';
                                }
                                ?>" class="img-fluid" alt="<?php echo $fetch_posts['imagealt']; ?>"></a>
                        </div>
                        <div class="post-cont single">
                            <h3><a href="#"><?php echo $fetch_posts['title']; ?></a></h3>
                            <?php echo $fetch_posts['mintext']; ?>
                            <?php
                            $r = str_replace('<p>', "", $fetch_posts['abstract']);
                            $r = str_replace('</p>', "", $r);
                            if($r != null){
                                ?>
                                <blockquote>
                                    <div class="quote">
                                        <img src="assets/images/icon-quote.png" class="img-fluid" alt="">
                                    </div>
                                    <p><?php echo $fetch_posts['abstract']; ?></p>
                                </blockquote>
                            <?php
                            }
                            ?>
                            <div class="blog-inner-cont row">
                                <p><?php echo $fetch_posts['textbody']; ?></p>
                            </div>
                        </div>
                    </div>
                    <!--end blog single-->
