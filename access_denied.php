...
<link href="admin/assets/vendors/global/vendors.bundle.rtl.css" rel="stylesheet" type="text/css"/>
<link href="admin/assets/css/style.bundle.rtl.css" rel="stylesheet" type="text/css"/>
<link href="admin/assets/css/pages/error/error-6.rtl.css" rel="stylesheet" type="text/css" />
<link href="admin/assets/css/pages/error/error-4.rtl.css" rel="stylesheet" type="text/css" />
...
<link href="admin/assets/css/skins/header/base/light.rtl.css" rel="stylesheet" type="text/css"/>
<link href="admin/assets/css/skins/header/menu/light.rtl.css" rel="stylesheet" type="text/css"/>
<link href="admin/assets/css/skins/brand/dark.rtl.css" rel="stylesheet" type="text/css"/>
<link href="admin/assets/css/skins/aside/dark.rtl.css" rel="stylesheet" type="text/css"/><!--end::Layout Skins -->
...
<link href="admin/assets/fonts/IranSans/css/fontiran.css" rel=stylesheet>
...
<div class="kt-grid kt-grid--ver kt-grid--root">
    <div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v6"
         style="background-image: url(admin/media/error/bg6.jpg);">
        <div class="kt-error_container">
            <div class="kt-error_subtitle kt-font-light">
                <h1>با عرض پوزش...</h1>
            </div>
            <p class="kt-error_description kt-font-light">
              سایت در دست به روز رسانی می باشد، لطفا بعدا امتحان نمایید.
            </p>
        </div>
    </div>
