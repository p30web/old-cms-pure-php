        ...
        init: function () {
            n(), $("#kt_login_signin_submit").click(function (t) {
                ...
                n.validate({
                    ...
                    success: function (r) {
                        if(r.status === 200){
                            i(n, "success", "ورود موفق. منتظر بمانید...");
                            setTimeout(function () {
                    ...
                    error: function (xhr, ajaxOptions, thrownError) {
                        if(xhr.status === 404){
                            setTimeout(function () {
                                e.removeClass("kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light").attr("disabled", !1), i(n, "danger", "نام کاربری یا گذرواژه اشتباه است. لطفا دوباره تلاش کنید.")
                            }, 2e3);
                        }else{
                            setTimeout(function () {
                                e.removeClass("kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light").attr("disabled", !1), i(n, "danger", "خطایی رخ داده است. لطفا دوباره تلاش کنید.")
                            }, 2e3);
                        }
                    }
                }))
