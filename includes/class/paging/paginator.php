...
class paginator
{
    ...
    protected $maxPagesToShow = 3;
    protected $previousText = 'قبل';
    protected $nextText = 'بعد';
    ...
    public function toHtml()
    {
        ...
        $html = '<div class="blog-pagination two text-center"><div class="pagination-border"></div><ul>';
        if ($this->getPrevUrl()) {
            $html .= '<li ><a href="' . htmlspecialchars($this->getPrevUrl()) . '">&laquo; ' . $this->previousText . '</a></li>';
        }
        foreach ($this->getPages() as $page) {
            if ($page['url']) {
                $html .= '<li ><a class=" ' . ($page['isCurrent'] ? 'active' : '') . '" href="' . htmlspecialchars($page['url']) . '">' . htmlspecialchars($page['num']) . '</a></li>';
            } else {
                $html .= '<li><span>' . htmlspecialchars($page['num']) . '</span></li>';
            }
        }
        if ($this->getNextUrl()) {
